...
const LandingHeader = () => {
    ...
    const linkClasses = classNames(
        ...
        '&_li:ml-6 &_li:border-b &_li:border-gray-dark md:&_li:border-none',
        'ease-in &_a:flex &_a:h-navigation-height &_a:w-full &_a:translate-y-8 &_a:items-center &_a:text-lg &_a:transition-[color,transform] &_a:duration-300',
        'md:&_a:translate-y-0 md:&_a:text-sm &_a:md:transition-colors &_a:hover:text-grey',
