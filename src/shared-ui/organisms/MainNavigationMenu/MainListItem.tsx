...
import MainListItemContent from './MainListItemContent';
...
const MainListItem = React.forwardRef(({ className, children, title, to, Icon, ...props }: ListItemProps, forwardedRef: any) => {
