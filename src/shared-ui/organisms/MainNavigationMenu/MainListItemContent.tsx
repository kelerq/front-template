...
const MainListItemContent: React.FC<ListItemContentProps> = ({ isHovered, Icon, title, children }) => {
    ...
    return (
        <div className={classNames('grid grid-cols-12 grid-rows-1 rounded-lg p-2 sm:p-0', isHovered && 'bg-accent-focus')}>
            ...
            <div className="hidden col-start-12 col-end-13 row-start-1 row-end-2 sm:flex justify-self-center place-self-center">
...
export default MainListItemContent;
